      ...
      <header className="sticky top-0 z-40 bg-white/95 dark:bg-black/95 backdrop-blur border-b border-slate-200 dark:border-neutral-800 transition-colors">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            >
              <div className="w-10 h-10 rounded-xl bg-teal-600 dark:bg-teal-500 flex items-center justify-center text-white shadow-md shadow-teal-500/20 group-hover:scale-105 transition">
              ...
              <div>
                <span className="text-lg font-bold tracking-tight text-slate-900 dark:text-white flex items-center">
                  Health Access <span className="text-teal-600 dark:text-teal-400 ml-1">.UZ</span>
                </span>
